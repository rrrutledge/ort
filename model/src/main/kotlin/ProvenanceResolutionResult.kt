...
data class ProvenanceResolutionResult(
    ...
    /**
     * The provenance of the package.
     */
    @JsonInclude(JsonInclude.Include.NON_NULL)
    val packageProvenance: KnownProvenance? = null,

    /**
     * The (recursive) sub-repositories of [packageProvenance]. The listing is empty if a
     * [packageProvenanceResolutionIssue] happened. Otherwise, it may only be incomplete if a
     * [nestedProvenanceResolutionIssue] happened.
     */
